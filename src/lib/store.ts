...
function rowToEstimate(r: any): Estimate {
  return {
    ...
    project_category: r.project_category || 'Custom Scope',
    scope_class: r.scope_class || 'Full-Scope Multi-Trade',
    job_complexity: r.job_complexity || 'Standard Scope',
    ...
    // Rollup fields
    area_count: Number(r.area_count ?? 0),
    ai_pending_suggestions_count: Number(r.ai_pending_suggestions_count ?? 0),
    ai_estimate_health_status: r.ai_estimate_health_status || 'Good',
    ai_estimate_rollup_summary: r.ai_estimate_rollup_summary || '',
...
function estimateToRow(est: Estimate, userId: string) {
  return {
    ...
    project_category: est.project_category || 'Custom Scope',
    scope_class: est.scope_class || 'Full-Scope Multi-Trade',
    job_complexity: est.job_complexity || 'Standard Scope',
    ...
    // Voice intake fields
    voice_transcript_raw: est.voice_transcript_raw || '',
    voice_transcript_cleaned: est.voice_transcript_cleaned || '',
    voice_detected_scope: est.voice_detected_scope || '',
    voice_detected_risks: est.voice_detected_risks || '',
